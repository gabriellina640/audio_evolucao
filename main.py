...
# ----------------------------
# Tenta carregar o .env para desenvolvimento local. No servidor, falha silenciosamente.
try:
...
# Inicializa o cliente. No Hugging Face, a chave virá dos Secrets.
...
def processar_audio(arquivo_audio):
    """
    Orquestra todo o processo: recebe um áudio, transcreve e preenche a evolução.
    """
